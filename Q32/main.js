...
var current_users = ['admin', 'eric', 'sarah', 'osaid', 'ali'];
;
var new_users = ['ali', 'eric', 'rabeeta', 'aiman', 'khushi'];
...
for (var _i = 0, new_users_1 = new_users; _i < new_users_1.length; _i++) {
    ...
    if (lower_current_users.includes(new_user.toLowerCase())) {
        console.log("The username ".concat(new_user, " has already been used. You will need to enter a new username."));
    }
    else {
